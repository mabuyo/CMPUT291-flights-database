...
drop view good_connections;
create view good_connections (src,dst,dep_date,flightno1,flightno2, layover,price, dep_time, arr_time) as
SELECT DISTINCT ff.src, ff.dst, ff.dep_date, ff.no1, ff.no2, ff.layover, ff.price, ff.dep_time, ff.arr_time, CASE WHEN a3.seats < a4.seats THEN a3.seats else a4.seats 
FROM
